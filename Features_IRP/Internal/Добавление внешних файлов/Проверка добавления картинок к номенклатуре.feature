...
//	И Я устанавливаю в данную базу расширение "IRP_TestExtension.cfe" из каталога "$КаталогПроекта$"
...
Сценарий: _0602 Проверка добавления картинки
	...
	И пауза 5
	И я делаю клик по элементу формы 'Этот сеанс' 'Отмена' 'Тип' UI Automation
